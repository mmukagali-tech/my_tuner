...
sealed class ErrorUtil {
  ...
  static String formatMessage(
    ...
    String fallback = 'An error has occurred',
      ...
      switch (error) {
        ...
        // final DioException e => _localizedError(
        //     'Network call error',
        //     (l) => _localizeDioException(e, l),
        //   ),
  ...
  // static String _localizeDioException(DioException e, Localization l) => switch (e.type) {
