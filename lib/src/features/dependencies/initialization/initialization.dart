...
import 'package:my_tuner/src/core/utils/error_util.dart';
import 'package:my_tuner/src/features/dependencies/initialization/initialize_dependencies.dart';
...
class InitializationExecutor
  ...
  Future<Dependencies>? _currentInitialization;
  ...
  Future<Dependencies> call({
    ...
    return _currentInitialization ??= Future<Dependencies>(() async {
      ...
      try {
        ...
        final dependencies = await initializeDependencies(onProgress: notifyProgress)
